...
const AudioComponent = ({ word }: { word: string }) => {
    ...
    return (
        <div className="relative">
            ...
            <button className="focus:outline-0 active:outline-0 z-10 relative bg-purple-200 rounded-full w-14 h-14 flex justify-center items-center" onClick={play} disabled={audioLoading || false}>
                {
